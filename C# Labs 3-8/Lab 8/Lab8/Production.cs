...
namespace Lab8
{
    ...
    {
        public delegate void ShowColorText();
        public delegate void JustFunction();
        public event JustFunction DoNothing;
        public delegate void ErrorZ(string mes);
        public event ErrorZ ErrorEvent;
        ...
        public Production(OrderTypes new_order)
            : base()
        {
            this.ErrorEvent += mes => Console.WriteLine(mes);
            switch (new_order)
            {
